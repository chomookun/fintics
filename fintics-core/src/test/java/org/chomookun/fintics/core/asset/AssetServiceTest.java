...
import org.chomookun.fintics.core.asset.entity.OhlcvEntity;
...
class AssetServiceTest extends CoreTestSupport {
    ...
    void getOhlcvsWithTypeDaily() {
        ...
        entityManager.flush();
        // when
        List<Ohlcv> ohlcvs = assetService.getOhlcvs(assetId, Ohlcv.Type.DAILY, dateTimeFrom, dateTimeTo, PageRequest.of(0, 10));
        // then
    ...
    void getOhlcvsWithTypeMinute() {
        ...
        entityManager.flush();
        // when
        List<Ohlcv> assetOhlcvs = assetService.getOhlcvs(assetId, Ohlcv.Type.MINUTE, dateTimeFrom, dateTimeTo, PageRequest.of(0, 10));
        // then
    ...
    void getOhlcvWithForwardSplit() {
        ...
        entityManager.flush();
        // when
        List<Ohlcv> dailyOhlcvs = assetService.getOhlcvs(
                assetId,
                Ohlcv.Type.DAILY,
    ...
    void getDividends() {
        ...
        List<Dividend> dividends = assetService.getDividends(dividendEntity.getAssetId(), dividendEntity.getDate(), dividendEntity.getDate(), pageable);
        // then
