package org.chomookun.fintics.core.asset.client.ohlcv;
 ...
 */
@Component
@ConditionalOnProperty(prefix = "fintics.core.asset.ohlcv-client", name = "class-name", havingValue="org.chomookun.fintics.core.asset.client.ohlcv.DefaultOhlcvClient")
@Slf4j
