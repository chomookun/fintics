...
public class BalanceHistoryService {
    ...
    public List<BalanceHistory> getBalanceHistories(String brokerId, LocalDate dateFrom, LocalDate dateTo) {
        return balanceHistoryRepository.findAllByBrokerId(brokerId, dateFrom, dateTo).stream()
