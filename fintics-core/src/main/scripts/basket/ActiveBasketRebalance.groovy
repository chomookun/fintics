...
if (proxyEnabled) {
    Map<String, String> proxySymbolMap = [
            ...
            ,"012330": "0204D0" // 현대모비스 -> KODEX 현대차로보틱스밸류체인TOP3플러스 (자동차가 아니라 피지컬AI 테마임)
            ,"028260": "138520" // 삼성물산 -> TIGER 삼성그룹 (건설이 아니라 삼성전자 반도체 테마임)
            ,"000810": "140700" // 삼성화재해상보험 -> KODEX 보험 (보험이 아니라 삼성전자 반도체 테마임)
    ]
