...
import org.chomoo.fintics.strategy.PythonStrategyRunner;
...
import org.chomoo.fintics.model.Strategy;
...
class PythonStrategyRunnerTest extends CoreTestSupport {
    ...
    String loadPythonFileAsString(String fileName) {
        ...
        try {
            filePath = new File(".").getCanonicalPath() + "/src/test/resources/org/chomoo/fintics/strategy/" + fileName;
        } catch (IOException e) {
