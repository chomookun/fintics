package org.chomookun.fintics.client.broker;
...
public abstract class BrokerClient {
     ...
     */
    public abstract List<DividendProfit> getDividendHistories(LocalDate dateFrom, LocalDate dateTo) throws InterruptedException;
